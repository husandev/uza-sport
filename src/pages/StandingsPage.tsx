...
import { groupStandings, topScorers } from "@/data/mockData";
import { Trophy, Target, Users } from "lucide-react";

const allGroups = groupStandings.map((g) => g.group);
                  ...
                  <tbody>
                    {g.teams.map((team, i) => {
                      ...
                      return (
                        ...
                        >
                          {/* Position with qualify indicator */}
                          ...
                          <td className="py-3">
                            <div className="flex items-center gap-2.5">
                              ...
                              <span className={`text-[13px] ${isUzb ? "font-bold text-primary" : "font-medium text-foreground"}`}>
                                {team.name}
                              </span>
                            </div>
                          </td>
          ...
          <div className="bg-card rounded-2xl shadow-sm p-5">
            ...
            <div className="space-y-2 text-[12px] font-body text-muted-foreground">
              <div className="flex items-center gap-2">
                <span className="font-semibold text-foreground">O'</span> — O'yinlar soni
              </div>
              <div className="flex items-center gap-2">
                <span className="font-semibold text-foreground">G'</span> — G'alabalar
              </div>
              <div className="flex items-center gap-2">
                <span className="font-semibold text-foreground">D</span> — Duranglar
              </div>
              <div className="flex items-center gap-2">
                <span className="font-semibold text-foreground">M</span> — Mag'lubiyatlar
              </div>
              <div className="flex items-center gap-2">
                <span className="font-semibold text-foreground">FT</span> — Farq tafsiloti
              </div>
              <div className="flex items-center gap-2">
                <span className="font-semibold text-foreground">O</span> — Ochkolar
              </div>
            </div>
          </div>
        </div>
